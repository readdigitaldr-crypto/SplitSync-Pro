...
class FriendRequestViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        Notification.objects.create(
            ...
            message=f"{req.sender.display_name()} sent a friend request.",
            kind="friend_request",
        )
    ...
    def accept(self, request, pk=None):
        ...
        with transaction.atomic():
            ...
            Friendship.objects.get_or_create(user=fr.sender, friend=fr.receiver)
            Friendship.objects.get_or_create(user=fr.receiver, friend=fr.sender)
...
class FriendshipViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def remove(self, request, pk=None):
        f = self.get_object()
        Friendship.objects.filter(user=f.friend, friend=request.user).delete()
        f.delete()
